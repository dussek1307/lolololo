           ...
           <div class='profileEdit-main'>
               ...
               <div class='profileEdit-bar'>
                   ...
                   <div>
                       ...
                       <label class='upload-btn'><input type='file' onchange='preview(event)' name='file' value='https://lolupccount.com/resources/img/post-main/sampleImg.jpg'/><span>업로드</span></label>
                       <div style='margin: 10px 0;'>
                           <img style='width: 500px;' src='./resources/img/post-main/sampleImg.jpg' id='img' alt=''>
                       </div> 
                   </div>
               </div>
           </div>
