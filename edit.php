<?php
   ...
   <!-- mobile-menu -->
	<nav class='nav-list'>
		<ul class='nav-links' style='padding-left: 0px; margin-top: 20px;'>";
			...
			echo "<li><a href='./about.php'>업카운트 소개</a></li>
   ...
   <div class='modal-body'>
       <form action='./account-page/edit-process.php' method='post' enctype='multipart/form-data'>
       <div class='profileEdit profileEdit-desktop'>
           <div class='profileEdit-main'>
               ...
               while($row = mysqli_fetch_assoc($result)) {
                  echo "<div class='profileEdit-bar-title'><span>계정 정보</span></div>
                  <div>
                      <div class='profileInfo-bar'>
                          <span class='profileInfo-label'><span>소환사명</span></span>
                          <div class='undefined Text-container'>
                              <!-- SUMMONER'S NAME -->
                              <input required name='summonerName' type='text' class='text-common undefined undefined' value='".$row['summonerName']."' placeholder='소환사명' dec='0' style='width: 200px;' />
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                      ...
                      <div class='profileInfo-bar'>
                          ...
                          <div class='TeacherApply-birthday-wrapper'>
                              <div>
                                  <select required class='menu-title select-style' name='soloRank' id=''>
                              ...
                              <div>
                                  <input style='width: 80px; height: 42px;' type='number' class='number-count' name='sWins' step='1' value='".$row['sWins']."' placeholder='승리'>
                                  <input style='width: 80px; height: 42px;' type='number' class='number-count' name='sLoses' step='1' value='".$row['sLoses']."' placeholder='패배'>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div class='TeacherApply-birthday-wrapper'>
                              <div>
                                  <select required class='menu-title select-style' name='flexRank' id=''>
                              ...
                              <div>
                              <input style='width: 80px; height: 42px;' type='number' class='number-count' name='fWins' step='1' value='".$row['fWins']."' placeholder='승리'>
                                  <input style='width: 80px; height: 42px;' type='number' class='number-count' name='fLoses' step='1' value='".$row['fLoses']."' placeholder='패배'>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          <span class='profileInfo-label'><span>명의</span></span>
                          <select required class='menu-title select-style' name='owner' id=''>
                              <option value='first'>1대 본주(본인명의)</option>
                              <option value='second'>2대 본주(타인명의)</option>
                              <option value='third'>3대 본주(타인명의)</option>
                          </select>
                          <input style='width: 80px; height: 42px;' type='number' class='number-count' name='level' step='1' value='".$row['level']."' placeholder='레벨'>
                      </div>
                      <div class='profileInfo-bar'>
                          <span class='profileInfo-label'><span>컬렉션</span></span>
                          <div>
                              <div class='cityMenu'>
                                  <select required class='menu-title select-style' name='numOfChams' id=''>
                                  ...
                                  <select required class='menu-title select-style' name='numOfSkins' id=''>
                                  ...
                                  <div class='undefined Text-container'><input style='width: 120px; height: 42px;' type='number' class='number-count' name='blueEssence' step='1' value='".$row['blueEssence']."' placeholder='파랑정수'></div>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div>
                              <div class='cityMenu'>
                                  <select required class='menu-title select-style' name='season9' id=''>
                                  ...
                                  <select required class='menu-title select-style' name='season10' id=''>
                      ...
                      <div class='profileInfo-bar'>
                          ...
                          <select required class='menu-title select-style' name='serverLocation'>
                  ...
                  <div>
                      <div class='profileInfo-bar'>
                          ...
                          <div>
                              <div class='native-language-row' id='language-menu-0'>
                                  <select required class='menu-title select-style' name='mostPlayed1' id=''>
                                  ...
                                  <input style='width: 60px; height: 42px;' type='number' class='number-count' name='numOfPlayed1' step='1' value='".$row['numOfPlayed1']."' placeholder='판수'>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div>
                              <div>
                                  <div class='language-skills-row'>
                                      <select required class='menu-title select-style' name='mostPlayed2' id=''>
                                          <option value='default'>선택</option>
                                          <option value='Garen'>가렌</option>
                                          <option value='Galio'>갈리오</option>
                                          <option value='Gangplank'>갱플랭크</option>
                                      ...
                                      <input style='width: 60px; height: 42px;' type='number' class='number-count' name='numOfPlayed2' step='1' value='".$row['numOfPlayed2']."' placeholder='판수'>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div>
                              <div>
                                  <div class='language-skills-row'>
                                      <select required class='menu-title select-style' name='mostPlayed3' id=''>
                                          <option value='default'>선택</option>
                                          <option value='Garen'>가렌</option>
                                          <option value='Galio'>갈리오</option>
                                          <option value='Gangplank'>갱플랭크</option>
                                      ...
                                      <input style='width: 60px; height: 42px;' type='number' class='number-count' name='numOfPlayed3' step='1' value='".$row['numOfPlayed3']."' placeholder='판수'>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div>
                      <div class='profileInfo-bar'>
                          ...
                          <div class='profile-introduction-input'>
                              <div class='textarea_left'>
                                  <div class='wrapbox'>
                                      <textarea required class='textarea_common textarea_limited' name='title' maxlength='1000' minlength='4' placeholder='' cols='40' lineheight='21' rows='5' style='width: 600px; height: 43px;'>".$row['title']."</textarea>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div class='profile-introduction-input'>
                              <div class='textarea_left'>
                                  <div class='wrapbox'>
                                      <input required value='".$row['price']."' id='price' name='price' type='text' class='text-common undefined undefined' placeholder='가격' dec='0' style='width: 250px; height: 43px;' />
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class='profile-introduction-input'>
                              <div class='textarea_left'>
                                  <div class='wrapbox'>
                                      <input onkeyup='inputPhoneNumber(this)' value='".$row['tel']."' required name='tel' type='text' class='text-common undefined undefined' placeholder='연락처' dec='0' style='width: 250px; height: 43px;' />
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div class='profileInfo-bar'>
                          ...
                          <div class='profile-introduction-input'>
                              <div class='textarea_left'>
                                  <div class='wrapbox'>
                                      <textarea required placeholder='허위사실로 계정정보 기재 시 통보없이 게시글이 삭제될 수 있습니다.' class='textarea_common textarea_limited' name='intro' maxlength='1000' minlength='10' placeholder='' cols='40' lineheight='21' rows='5' style='width: 600px; height: 130px;'>".$row['intro']."</textarea>
          ...
          <div class='modal-footer profile-setting-modal-footer'>
              <div class='profileSetting-modal-footer-inner'>
                  ...
                  <button name='submit' type='submit' class='btn btn-standard btn-main'><span>수정하기</span></button>
              </div>
          </div>
      </div>
      </form>
